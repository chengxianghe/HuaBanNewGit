...
typealias SMSegmentViewDidSelectIndex = (segmentView: SMSegmentView, index: NSInteger) -> Void
...
class SMSegmentView: UIView, SMSegmentDelegate {
    ...
    var didSelectIndexClosure: SMSegmentViewDidSelectIndex?
    ...
    func updateSegmentWithTitle(index: NSInteger, title: String?) {
    ...
    func selectSegment(segment: SMSegment) {
        ...
        self.didSelectIndexClosure?(segmentView: self, index: segment.index)
    }
    
    func setSegmentDidSelectIndexClosure(didSelect: SMSegmentViewDidSelectIndex?) {
        self.didSelectIndexClosure = didSelect
    }
